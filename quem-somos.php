...
<section class="about py-5">
	<div class="container py-sm-3">
		<h3 class="heading text-capitalize mb-lg-5 mb-4"> Historia - <span> Medicina na Argentina</span> </h3>
		<div class="row about-grids">
			<div class="col-lg-6">
				<h4>Medicinarg</h4>
				<p class="mb-3">Medicina na Argentina foi o melhor jeito que encontrei de estudar fora do Brasil e com qualidade, tudo começou quando conversei com outros dois amigos sobre nossas dificuldades em estudar no exterior, estudar e aprimorar seus estudos na Argentina que eram os quesitos principais, e percebendo a grande dificuldade que os brasileiros tinham em resolver as questões documentais e de inscrição nas universidades, 
								resolvemos abrir uma empresa para fomentar, fortelecer, divulgar e facilitar o acesso as universidades na Argentina, estimulando milhares de brasileiros a estudar na Argentina com preço justo.</br>
								Estude Medicina sem vestibular na Argentina, com certeza você vai amar, alem do preço justo das universidades pagas, mas tem as públicas também e a facilidade do ingresso. Depois tem o seguinte, o diploma argentino é válido em toda a Europa.
								O Projeto não para por ai temos como proposito atingir em pouco tempo os demais países da America Latina.</p>
			</div>
			<div class="col-lg-6 mt-lg-0 mt-5">
				<img src="images/formando-medicina.png" alt="Imagem de um formando em Medicina" class="img-fluid"/>
			</div>
		</div>
	</div>
</section>
