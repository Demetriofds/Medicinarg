				...
				<ul class="navbar-nav ml-lg-auto text-center">
					...
					<li class="dropdown nav-item mr-lg-3">
						...
						<ul class="dropdown-menu" role="menu">
							<li class="nav-item">
								<a href="faculdades.php" class="nav-link">Faculdades</a>
							</li>
							<li class="nav-item">
								<a href="parceiros/cadastro_parceiros.php" class="nav-link">Cadastro Parceiros</a>
							</li>
							<!--<li class="nav-item">
	 ...
	 <!-- inner banner -->
		...
		<section class="services py-5">
			<div class="container py-sm-3">
				<h3 class="heading text-capitalize mb-lg-5 mb-4"> Parceiros  - <span>What We Offer</span> </h3>
				<div class="row service-grids">
					<div class="col-lg-4 col-md-6">
						<div class="service-grid1">
							<i class="fas fa-globe"></i>
							<h4 class="mb-3">Preço</h4>
							<h5>Gratuita</h5>
						</div>
					</div>
