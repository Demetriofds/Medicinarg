 ...
 * main.js
 *
 * author: Encode One Team
 */
App={init:function(){return this.bindActions(),this},bindActions:function(){var n=this;this.handleScrollBar();this.initTooltips();this.initPopovers();this.handleSlideMenu();this.handleMobileMenu();this.changeLang();this.handleSwitchery();this.handleMasonryLayout();this.handleMenuTypehead()},handleScrollBar:function(){window.PerfectScrollbar&&$(".do-scroll").length&&$(".do-scroll").each(function(){return new PerfectScrollbar(this,{})})},initTooltips:function(){$('[data-toggle="tooltip"]').tooltip()},initPopovers:function(){$('[data-toggle="popover"]').popover()},handleSlideMenu:function(){if(window.SlideMenu&&$("#slide-menu").length)return new SlideMenu},handleMobileMenu:function(){},changeLang:function(){$(".changeCulture").click(function(n){n.preventDefault();cookieString!==""?$("#cookieModalAlertWarning").modal().show():$.get("/Generics/ChangeCulture?culture="+$(this).attr("culture"),function(n){n==="OK"&&location.reload()})});$(".btnCookieOk").click(function(){document.cookie=cookieString;$("#cookieModalAlertWarning").modal().hide();cookieString=""})},handleSwitchery:function(){var n,t,i;if(Array.prototype.forEach)n=Array.prototype.slice.call(document.querySelectorAll(".js-switch")),n.forEach(function(n){var t=new Switchery(n,{size:"small"})});else for(n=document.querySelectorAll(".js-switch"),t=0;t<n.length;t++)i=new Switchery(n[t],{size:"small"})},handleMasonryLayout:function(){$(window).on("load",function(){window.Masonry&&$(".masonry-layout").masonry({itemSelector:".masonry-item",columnWidth:".masonry-item:first-child",percentPosition:!0})})},handleMenuTypehead:function(){var n=$("#menuSearch");n.typeahead({source:menuList,autoSelect:!1,fitToElement:!0,afterSelect:function(n){location.replace(n.id)},items:10})}};EncodeOne=App.init();$(document).ready(function(){$("#btnRtl").click(function(){$("body").toggleClass("smart-rtl")})});$("body").on("click","[data-et-action]",function(n){n.preventDefault();var i=$(this),r=i.data("et-action"),t="";switch(r){case"search-open":$(".search").addClass("search--toggled");break;case"search-close":$(".search").removeClass("search--toggled");break;case"aside-open":t=i.data("et-target");i.addClass("toggled");$(t).addClass("toggled");$(".container-fluid, .main-header").append('<div class="et-backdrop" data-et-action="aside-close" data-et-target='+t+" />");break;case"aside-close":t=i.data("et-target");$('[data-et-action="aside-open"], '+t).removeClass("toggled");$(".container-fluid, .main-header").find(".et-backdrop").remove();break;case"fullscreen":a(document.documentElement);break;case"print":window.print();break;case"scroll-top":return $("html, body").animate({scrollTop:0},"slow"),!1}});